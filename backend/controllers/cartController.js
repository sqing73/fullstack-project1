...
exports.updateCart = async (req, res) => {
    try {
        ...
        console.log('updateCart - Received Product ID:', productId);
        console.log('updateCart - Received Quantity:', quantity);

        // Validate the product
        const product = await Product.findById(productId);
        console.log('updateCart - Product Lookup Result:', product);
        ...
        console.log('updateCart - Item Index in Cart:', itemIndex);
